...
class gridphp_dbr extends gridphp_module{
	...
	*/
	public function &query($sql, $condition, $rw = 'r'){ return $this->_callImplements(); }
	...
	* @return int
	*/
	public function &query_affected_rows($condition, $rw = 'w'){ return $this->_callImplements(); }
	...
	* @return array
	*/
	public function &fetch($sql = null, $condition, $cachetime = null){ return $this->_callImplements(); }
	...
	* @return array
	*/
	public function &fetch_all($sql = null, $condition, $cachetime = null){ return $this->_callImplements(); }
